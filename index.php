...
<div class="container">
	<div id="login_form" class="well">
		...
		<div style="height: 10px;"></div>
		<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-log-in"></span> Login</button> No account? <a href="signup.php"> Sign up</a><br/>Forget Password?<a href="forget.php"> Click here</a>
		</form>
